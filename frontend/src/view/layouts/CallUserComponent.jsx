    ...
    <Card className="w-full max-w-lg bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
      ...
      <div className="flex flex-col items-center pb-10">
        ...
        <div className="flex mt-4 md:mt-6 gap-3">
          <Button className="inline-flex items-center px-8 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-600 dark:hover:bg-green-700 w-30 cursor-pointer">
            Call <PhoneCall />
          </Button>
